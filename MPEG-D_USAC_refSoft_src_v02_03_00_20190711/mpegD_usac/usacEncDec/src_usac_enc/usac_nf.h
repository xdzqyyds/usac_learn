...
$Id: usac_nf.h,v 1.2 2010-09-13 20:29:22 mul Exp $
*******************************************************************************/
#ifndef USAC_NF_H
#define USAC_NF_H
...
void	usac_noise_filling(UsacToolsInfo *tool_data,double *spectrum, UsacQuantInfo   *qInfo, int *sfb_offset, int max_sfb);
