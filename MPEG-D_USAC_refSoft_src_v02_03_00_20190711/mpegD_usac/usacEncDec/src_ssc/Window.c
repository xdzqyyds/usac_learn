...
/*************************GLOBAL FUNCTION**************************************
 * 
 * Name        : SSC_WINDOW_HANNING_Initialise
 *
 * Description : Initialises windowing defined by Synthesizer Control
 *
 * Parameters  : 
 *
 * Returns:    : 
...
/*************************GLOBAL FUNCTION**************************************
 * 
 * Name        : SSC_WINDOW_Free
 *
 * Description : Frees window module.
 *
 * Parameters  : 
 *
 * Returns:    : 
...
/*************************GLOBAL FUNCTION**************************************
 * 
 * Name        : SSC_WINDOW_CreateInstance
 *
 * Description : Creates instance of window
 *
 * Parameters  : 
 *
 * Returns:    : pWindow - pointer to window instance
 * 
 *****************************************************************************/
...
SSC_WINDOW* SSC_WINDOW_CreateInstance(void)
{
    ...
    pWindow = SSC_MALLOC(sizeof(SSC_WINDOW), "SSC_WINDOW Instance");
...
/*************************GLOBAL FUNCTION**************************************
 * 
 * Name        : SSC_WINDOW_Destroy
 *
 * Description : Destroys window instance
 *
 * Parameters  : pWindow - pointer to window instance
 *
 * Returns:    : 
 * 
 *****************************************************************************/

void SSC_WINDOW_DestroyInstance(SSC_WINDOW* pWindow)
{
	if (pWindow != NULL)
	{
		SSC_FREE(pWindow, "SSC_Window Instance");
	}
}

/*************************GLOBAL FUNCTION**************************************
 * 
 * Name        : SSC_WINDOW_WindowSignal
 *
 * Description : Windows signal defined by synthesizer control
 *
 * Parameters  : pWindow        -   pointer to window instance
 *               pWindowShape   -   Normalised window array
 *               pInput         -   Input signal buffer
 *               Length         -   Length of window array
 *               pOutput        -   Output signal buffer
 *
 * Returns:    : 
 * 
 *****************************************************************************/
                             ...
                             SSC_SAMPLE_INT*       pOutput)
{
	...
	assert(pWindow);
    pWindow = pWindow ; /* suppress compiler warning */

    for (i=0; i<Length; i++)
    {
        pOutput[i] = pInput[i] * pWindowShape[i];
    }
}
