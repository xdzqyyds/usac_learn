...
/*********************************************************************
* Definition of hufAmpContRel_2 huffman decoder
* (Automatically generated - casting needed to avoid warnings on MSVC)
**********************************************************************/
static const HUFFMAN_LUT _hufAmpContRel_2_[] =
                    {{    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 2}},
                     {     1, {(PHUFFMAN_LUT)      0}},
                     {     2, {(PHUFFMAN_LUT)     -4}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 4}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 6}},
                     {     3, {(PHUFFMAN_LUT)      4}},
                     {     4, {(PHUFFMAN_LUT)     -8}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 8}},
                     {     5, {(PHUFFMAN_LUT)      8}},
                     {    -2, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 10}},
                     {    -2, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 14}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 22}},
                     {     7, {(PHUFFMAN_LUT)     12}},
                     {     7, {(PHUFFMAN_LUT)    -12}},
                     {     9, {(PHUFFMAN_LUT)    -24}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 18}},
                     {     9, {(PHUFFMAN_LUT)     20}},
                     {     9, {(PHUFFMAN_LUT)    -20}},
                     {    -1, {(PHUFFMAN_LUT) _hufAmpContRel_2_ + 20}},
                     {    10, {(PHUFFMAN_LUT)     24}},
                     {    11, {(PHUFFMAN_LUT)     28}},
                     {    11, {(PHUFFMAN_LUT)    -28}},
                     {     8, {(PHUFFMAN_LUT)     16}},
...
const HUFFMAN_DECODER hufAmpContRel_2 = {(PHUFFMAN_LUT)_hufAmpContRel_2_, 1};
/*********************************************************************/
