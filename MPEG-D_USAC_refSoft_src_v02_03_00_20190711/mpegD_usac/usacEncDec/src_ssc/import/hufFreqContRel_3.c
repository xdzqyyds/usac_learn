...
Source file: hufFreqContRel_3.c
...
/*********************************************************************
* Definition of hufFreqContRel_3 huffman decoder
* (Automatically generated - casting needed to avoid warnings on MSVC)
**********************************************************************/
static const HUFFMAN_LUT _hufFreqContRel_3_[] =
                    {{     1, {(PHUFFMAN_LUT)      0}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 2}},
                     {     2, {(PHUFFMAN_LUT)     -8}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 4}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 6}},
                     {     3, {(PHUFFMAN_LUT)      8}},
                     {     4, {(PHUFFMAN_LUT)    -16}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 8}},
                     {    -2, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 10}},
                     {     5, {(PHUFFMAN_LUT)     16}},
                     {     7, {(PHUFFMAN_LUT)    -32}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 14}},
                     {     7, {(PHUFFMAN_LUT)     24}},
                     {     7, {(PHUFFMAN_LUT)    -24}},
                     {     8, {(PHUFFMAN_LUT)     32}},
                     {    -1, {(PHUFFMAN_LUT) _hufFreqContRel_3_ + 16}},
                     {     9, {(PHUFFMAN_LUT)     40}},
                     {     9, {(PHUFFMAN_LUT)    -40}}};

const HUFFMAN_DECODER hufFreqContRel_3 = {(PHUFFMAN_LUT)_hufFreqContRel_3_, 1};
/*********************************************************************/
