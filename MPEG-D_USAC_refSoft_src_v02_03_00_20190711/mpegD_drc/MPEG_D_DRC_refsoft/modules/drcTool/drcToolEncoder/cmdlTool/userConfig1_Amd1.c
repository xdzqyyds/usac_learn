...
int
configureEnc1_Amd1(EncParams* encParams,
                   ...
                   UniDrcGainExt* encGainExtension)
{
    ...
    s=0;
    {
        ...
        encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.parametricDrcGainSetParams[s].levelEstimChannelWeightFormat = 1;
