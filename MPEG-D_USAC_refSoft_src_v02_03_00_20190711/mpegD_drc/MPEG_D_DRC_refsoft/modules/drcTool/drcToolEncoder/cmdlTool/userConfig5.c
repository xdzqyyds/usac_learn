...
int
configureEnc5(EncParams* encParams,
              ...
              UniDrcGainExt* encGainExtension)
{
    ...
    encConfig->drcInstructionsUniDrcCount = 15;
    n=0;
    {
    ...
    n=1;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 9;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
    ...
    n=2;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_DIALOG;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
    ...
    n=4;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NIGHT + EFFECT_BIT_NOISY + EFFECT_BIT_GENERAL_COMPR;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
    ...
    n=5;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NIGHT + EFFECT_BIT_NOISY;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
        ...
        encConfig->drcInstructionsUniDrc[n].limiterPeakTargetPresent = 1;
        encConfig->drcInstructionsUniDrc[n].limiterPeakTarget = 1.0f;
    }
    n=6;
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 9;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NIGHT + EFFECT_BIT_NOISY + EFFECT_BIT_DIALOG + EFFECT_BIT_GENERAL_COMPR + EFFECT_BIT_ARTISTIC;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
    ...
    n=7;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_CLIPPING;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
        ...
        encConfig->drcInstructionsUniDrc[n].limiterPeakTargetPresent = 1;
        encConfig->drcInstructionsUniDrc[n].limiterPeakTarget = -7.0f;
    }
    n=8;
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 0;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 1;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_CLIPPING;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
    ...
    {
        {
            ...
            encConfig->drcInstructionsUniDrc[n].duckingModifiersForChannel[ch].duckingScaling = 2.0f;
            ch=4;
            encConfig->drcInstructionsUniDrc[n].gainSetIndex[ch] = 4;
    ...
    n=13;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].drcLocation = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 3;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_CLIPPING;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
    ...
    /***********  loudnessInfo  *************/
    encLoudnessInfoSet->loudnessInfoCount = 11;
    n=0;
    {
        ...
        encLoudnessInfoSet->loudnessInfo[n].measurementCount = 5;
        m=0;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -32.0f;
        ...
        m=1;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_SHORT_TERM_LOUDNESS_MAX;
        ...
        m=2;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_LOUDNESS_RANGE;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = 20.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=3;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_MIXING_LEVEL;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = 90.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=4;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_ROOM_TYPE;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = 1.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=1;
    {
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -23.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=1;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_SHORT_TERM_LOUDNESS_MAX;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -7.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=2;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 2;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -15.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=1;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_ANCHOR_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -17.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=2;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_SHORT_TERM_LOUDNESS_MAX;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -4.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=3;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_MOMENTARY_LOUDNESS_MAX;
        ...
        m=4;
        {
            ...
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -8.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=3;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 3;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 1;
        ...
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelMeasurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelReliability = RELIABILITY_ACCURATE;
        encLoudnessInfoSet->loudnessInfo[n].measurementCount = 0;
    }
    n=4;
    {
    ...
    n=5;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 6;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 1;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 2.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 1;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevel = 4.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelMeasurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelReliability = RELIABILITY_ACCURATE;
        encLoudnessInfoSet->loudnessInfo[n].measurementCount = 0;
    }
    n=6;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 7;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 0;
        ...
        m=1;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -20.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EXPERT_PANEL;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=2;
        {
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_MOMENTARY_LOUDNESS_MAX;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -2.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
        m=4;
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_MAX_OF_LOUDNESS_RANGE;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -3.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_EBU_R_128;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=7;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 8;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 0;
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -9.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=8;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 12;
    ...
    n=9;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 13;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 2;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 0;
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -12.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=10;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 14;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 2;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 1;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevel = -3.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelMeasurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelReliability = RELIABILITY_ACCURATE;
        encLoudnessInfoSet->loudnessInfo[n].measurementCount = 2;
        m=0;
