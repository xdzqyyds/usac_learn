...
int
configureEnc3_Amd1(EncParams* encParams,
                   ...
                   UniDrcGainExt* encGainExtension)
{
    ...
    n=0;
    {
        ...
        encConfig->drcCoefficientsUniDrc[n].gainSequenceCount = 1;
    ...
    encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.parametricDrcDelayMax        = 576;
    encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.resetParametricDrc = 0;
    
    /***********  parametricDrcSequenceParams  *************/
    encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.parametricDrcGainSetCount = 1;
    s=0;
    {
        encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.parametricDrcGainSetParams[s].parametricDrcId = 0;
    ...
    encConfig->uniDrcConfigExt.parametricDrcInstructionsCount = 1;
    s=0;
    {
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcId = 0;
