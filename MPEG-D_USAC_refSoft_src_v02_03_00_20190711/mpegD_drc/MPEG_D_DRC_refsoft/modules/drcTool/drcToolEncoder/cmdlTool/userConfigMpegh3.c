...
int
configureEncMpegh3(EncParams* encParams,
                   ...
                   UniDrcGainExt* encGainExtension)
{
    ...
    n=0;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = -19;
        ch=0;
    ...
    n=1;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 1;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = -19;
    ...
    n=3;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].mae_groupID = 10;
        encConfig->drcInstructionsUniDrc[n].mae_groupPresetID = 0;
    }
    n=4;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].mae_groupID = 0;
        encConfig->drcInstructionsUniDrc[n].mae_groupPresetID = 5;
    }
    ...
    n=0;
    {
        ...
        encConfig->drcCoefficientsUniDrc[n].gainSetCount = 1;
        s=0;
        {
            ...
            encConfig->drcCoefficientsUniDrc[n].gainSetParams[s].gainParams[0].crossoverFreqIndex = 0;  /* not used*/
        }
    }
    ...
    n=0;
    {
        ...
        m=0;
        {
            ...
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -30.0f;
    ...
    n=1;
    {
        ...
        encLoudnessInfoSet->loudnessInfo[n].mae_groupID = 0;
        encLoudnessInfoSet->loudnessInfo[n].mae_groupPresetID = 0;
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 63;
    ...
    n=3;
    {
        ...
        encLoudnessInfoSet->loudnessInfo[n].mae_groupPresetID = 2;
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 3;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 127;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevel = 0.0f;
    ...
    n=4;
    {
        ...
        encLoudnessInfoSet->loudnessInfo[n].mae_groupID = 7;
        encLoudnessInfoSet->loudnessInfo[n].mae_groupPresetID = 0;
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 63;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 1;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
    ...
    n=6;
    {
        ...
        encLoudnessInfoSet->loudnessInfo[n].mae_groupPresetID = 0;
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 63;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 3;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevel = 0.0f;
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -35.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=7;
    {
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -40.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
    n=8;
    {
        ...
        {
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodDefinition = METHOD_DEFINITION_PROGRAM_LOUDNESS;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].methodValue = -45.0f;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].measurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
            encLoudnessInfoSet->loudnessInfo[n].loudnessMeasure[m].reliability = RELIABILITY_ACCURATE;
        }
    }
