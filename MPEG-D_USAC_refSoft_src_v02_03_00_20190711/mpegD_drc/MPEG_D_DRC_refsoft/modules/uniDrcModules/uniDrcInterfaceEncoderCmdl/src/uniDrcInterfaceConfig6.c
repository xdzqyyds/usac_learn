...
int
uniDrcInterfaceConfigEnc6(UniDrcInterface* uniDrcInterface)
{
    ...
    uniDrcInterface->dynamicRangeControlParameterInterface.boost                   = 0.f;
    
    uniDrcInterface->dynamicRangeControlParameterInterface.changeDrcCharacteristicTarget = 1;
    uniDrcInterface->dynamicRangeControlParameterInterface.drcCharacteristicTarget       = 7;
