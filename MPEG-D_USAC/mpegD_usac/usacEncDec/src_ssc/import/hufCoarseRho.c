...
/*********************************************************************
* Definition of hufCoarseRho huffman decoder
* (Automatically generated - casting needed to avoid warnings on MSVC)
**********************************************************************/
static const HUFFMAN_LUT _hufCoarseRho_[] =
                    {{    -1, {(PHUFFMAN_LUT) _hufCoarseRho_ + 2}},
                     {     1, {(PHUFFMAN_LUT)      0}},
                     {     2, {(PHUFFMAN_LUT)      1}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRho_ + 4}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRho_ + 6}},
                     {     3, {(PHUFFMAN_LUT)     -1}},
                     {     4, {(PHUFFMAN_LUT)      2}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRho_ + 8}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRho_ + 10}},
                     {     5, {(PHUFFMAN_LUT)     -2}},
                     {     6, {(PHUFFMAN_LUT)      3}},
                     {     6, {(PHUFFMAN_LUT)     -3}}};

const HUFFMAN_DECODER hufCoarseRho = {(PHUFFMAN_LUT)_hufCoarseRho_, 1};
/*********************************************************************/
