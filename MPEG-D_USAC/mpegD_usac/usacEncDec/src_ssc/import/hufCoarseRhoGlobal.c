...
Source file: hufCoarseRhoGlobal.c
...
/*********************************************************************
* Definition of hufCoarseRhoGlobal huffman decoder
* (Automatically generated - casting needed to avoid warnings on MSVC)
**********************************************************************/
static const HUFFMAN_LUT _hufCoarseRhoGlobal_[] =
                    {{     1, {(PHUFFMAN_LUT)      2}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRhoGlobal_ + 2}},
                     {    -1, {(PHUFFMAN_LUT) _hufCoarseRhoGlobal_ + 4}},
                     {     2, {(PHUFFMAN_LUT)      3}},
                     {     3, {(PHUFFMAN_LUT)      1}},
                     {     3, {(PHUFFMAN_LUT)      0}}};

const HUFFMAN_DECODER hufCoarseRhoGlobal = {(PHUFFMAN_LUT)_hufCoarseRhoGlobal_, 1};
/*********************************************************************/
