...
Source file: hufFineRhoGlobal.c
...
/*********************************************************************
* Definition of hufFineRhoGlobal huffman decoder
* (Automatically generated - casting needed to avoid warnings on MSVC)
**********************************************************************/
static const HUFFMAN_LUT _hufFineRhoGlobal_[] =
                    {{     1, {(PHUFFMAN_LUT)      5}},
                     {    -2, {(PHUFFMAN_LUT) _hufFineRhoGlobal_ + 2}},
                     {    -1, {(PHUFFMAN_LUT) _hufFineRhoGlobal_ + 6}},
                     {     3, {(PHUFFMAN_LUT)      4}},
                     {     3, {(PHUFFMAN_LUT)      6}},
                     {     3, {(PHUFFMAN_LUT)      0}},
                     {     4, {(PHUFFMAN_LUT)      3}},
                     {    -1, {(PHUFFMAN_LUT) _hufFineRhoGlobal_ + 8}},
                     {    -1, {(PHUFFMAN_LUT) _hufFineRhoGlobal_ + 10}},
                     {     5, {(PHUFFMAN_LUT)      1}},
                     {     6, {(PHUFFMAN_LUT)      7}},
                     {     6, {(PHUFFMAN_LUT)      2}}};

const HUFFMAN_DECODER hufFineRhoGlobal = {(PHUFFMAN_LUT)_hufFineRhoGlobal_, 1};
/*********************************************************************/
