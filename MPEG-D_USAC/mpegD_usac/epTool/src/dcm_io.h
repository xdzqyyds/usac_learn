 ...
 *                                                                           *
 ****************************************************************************/
#ifndef __INCLUDED_DCM_IO_H
#define __INCLUDED_DCM_IO_H

#include <stdio.h>

int writebits(FILE *fpout,int packetlen,int *buffer);
int readbits(FILE *fpin, int  packetlen, int *buffer);

#endif /* __INCLUDED_DCM_IO_H */
