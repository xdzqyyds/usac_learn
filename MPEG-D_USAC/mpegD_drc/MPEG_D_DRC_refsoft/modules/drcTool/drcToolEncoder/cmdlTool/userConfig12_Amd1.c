...
int
configureEnc12_Amd1(EncParams* encParams,
              ...
              UniDrcGainExt* encGainExtension)
{
    ...
    n=0;
    {
        ...
        uniDrcConfigExt->drcCoefficientsUniDrcV1[n].shapeFilterCount = 0;
        ...
        s=0;
        {
            ...
            uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].timeAlignment = 1;
            uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].timeDeltaMinPresent = 1;
            uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].deltaTmin = 64;
            uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].drcBandType = 1;
            uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].bandCount = 2;
            b=0;
            {
                ...
                uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].gainParams[b].crossoverFreqIndex = 0;
                uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].gainParams[b].startSubBandIndex = 0;
            }
            b=1;
            {
                uniDrcConfigExt->drcCoefficientsUniDrcV1[n].gainSetParams[s].gainParams[b].gainSequenceIndex = 0;
    ...
    n=0;
    {
     ...
     /* uniDrcConfigExt->drcInstructionsUniDrcV1[n].drcSetComplexityLevel = 3;  will be computed */
        ...
        g=0;
        {
            ...
            b=1;
            {
                ...
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].attenuationScaling[b] = 1.0f;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].amplificationScaling[b] = 0.25f;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].gainOffsetPresent[b] = 0;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].gainOffset[b] = 0.0f;
            }
        }
     ...
     /* uniDrcConfigExt->drcInstructionsUniDrcV1[n].drcSetComplexityLevel = 3; will be computed */
        ...
        g=0;
        {
            ...
            b=1;
            {
                ...
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].gainScalingPresent[b] = 1;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].attenuationScaling[b] = 1.0f;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].amplificationScaling[b] = 0.125f;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].gainOffsetPresent[b] = 0;
                uniDrcConfigExt->drcInstructionsUniDrcV1[n].gainModifiers[g].gainOffset[b] = 0.0f;
            }
        }
