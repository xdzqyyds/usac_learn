...
int
configureEnc6(EncParams* encParams,
              ...
              UniDrcGainExt* encGainExtension)
{
    ...
    encConfig->drcInstructionsUniDrcCount = 8;
    n=0;
    {
    ...
    n=1;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NOISY + EFFECT_BIT_NIGHT;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 1;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = -20;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 1;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = -26;
        ch=0;
        encConfig->drcInstructionsUniDrc[n].gainSetIndex[ch] = 1;
        ch=1;
        encConfig->drcInstructionsUniDrc[n].gainSetIndex[ch] = -1;
    ...
    n=2;
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        encConfig->drcInstructionsUniDrc[n].downmixId = 0;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdPresent = 1;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdCount = 1;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixId[0] = 3;
        encConfig->drcInstructionsUniDrc[n].drcLocation = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 1;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_CLIPPING + EFFECT_BIT_NOISY;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 1;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = -10;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
        ch=0;
    ...
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        encConfig->drcInstructionsUniDrc[n].downmixId = 1;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdPresent = 0;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdCount = 0;
        encConfig->drcInstructionsUniDrc[n].drcLocation = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 0;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NOISY + EFFECT_BIT_DIALOG;
        ...
        encConfig->drcInstructionsUniDrc[n].limiterPeakTarget = -10.0f;
    }
    n=4;
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        ...
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_NIGHT + EFFECT_BIT_LOWLEVEL;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
    ...
    n=5;
    {
        ...
        encConfig->drcInstructionsUniDrc[n].duckingModifiersForChannel[ch].duckingScaling = 1.f;
        ch=1;
        encConfig->drcInstructionsUniDrc[n].gainSetIndex[ch] = -1;
        encConfig->drcInstructionsUniDrc[n].duckingModifiersForChannel[ch].duckingScalingPresent = 1;
        encConfig->drcInstructionsUniDrc[n].duckingModifiersForChannel[ch].duckingScaling = 1.f;
    ...
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        encConfig->drcInstructionsUniDrc[n].downmixId = 4;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdPresent = 0;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdCount = 0;
        encConfig->drcInstructionsUniDrc[n].drcLocation = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 0;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSet = 0;
        encConfig->drcInstructionsUniDrc[n].noIndependentUse = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetEffect = EFFECT_BIT_DUCK_SELF;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueUpper = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLowerPresent = 0;
        encConfig->drcInstructionsUniDrc[n].drcSetTargetLoudnessValueLower = 0;
    ...
    {
        encConfig->drcInstructionsUniDrc[n].drcSetId = n+1;
        encConfig->drcInstructionsUniDrc[n].downmixId = 5;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdPresent = 0;
        encConfig->drcInstructionsUniDrc[n].additionalDownmixIdCount = 0;
        encConfig->drcInstructionsUniDrc[n].drcLocation = 1;
        encConfig->drcInstructionsUniDrc[n].dependsOnDrcSetPresent = 0;
    ...
    n=1;
    {
        encLoudnessInfoSet->loudnessInfo[n].drcSetId = 5;
        encLoudnessInfoSet->loudnessInfo[n].downmixId = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevelPresent = 0;
        encLoudnessInfoSet->loudnessInfo[n].samplePeakLevel = 0.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelPresent = 1;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevel = -10.0f;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelMeasurementSystem = MEASUREMENT_SYSTEM_BS_1770_3;
        encLoudnessInfoSet->loudnessInfo[n].truePeakLevelReliability = RELIABILITY_ACCURATE;
        encLoudnessInfoSet->loudnessInfo[n].measurementCount = 1;
        m=0;
    ...
    encConfig->channelLayout.layoutSignalingPresent = 1;
    encConfig->channelLayout.definedLayout = 5;
    encConfig->channelLayout.speakerPosition[0] = 0;
    
    /***********  downmixInstructions  *************/
    encConfig->downmixInstructionsCount = 5;
    n=0;
    {
        encConfig->downmixInstructions[n].downmixId = 1;
        encConfig->downmixInstructions[n].targetChannelCount = 2;
        encConfig->downmixInstructions[n].targetLayout = 2;
        encConfig->downmixInstructions[n].downmixCoefficientsPresent = 1;
        encConfig->downmixInstructions[n].downmixCoefficient[0] = 1.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[1] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[2] = 0.7f;
        encConfig->downmixInstructions[n].downmixCoefficient[3] = 0.7f;
        encConfig->downmixInstructions[n].downmixCoefficient[4] = 0.0f;
        ...
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+2] = 0.7f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+3] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+4] = 0.7f;
    }
    n=1;
    {
        encConfig->downmixInstructions[n].downmixId = 2;
        encConfig->downmixInstructions[n].targetChannelCount = 4;
        encConfig->downmixInstructions[n].targetLayout = 4;
        encConfig->downmixInstructions[n].downmixCoefficientsPresent = 1;
    ...
    n=2;
    {
        ...
        encConfig->downmixInstructions[n].targetLayout = 2;
        encConfig->downmixInstructions[n].downmixCoefficientsPresent = 1;
        encConfig->downmixInstructions[n].downmixCoefficient[0] = 0.8f;
        encConfig->downmixInstructions[n].downmixCoefficient[1] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[2] = 0.5f;
        encConfig->downmixInstructions[n].downmixCoefficient[3] = 0.5f;
        encConfig->downmixInstructions[n].downmixCoefficient[4] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+0] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+1] = 0.8f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+2] = 0.5f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+3] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[1*5+4] = 0.5f;
    }
    n=3;
    {
        encConfig->downmixInstructions[n].downmixId = 4;
        encConfig->downmixInstructions[n].targetChannelCount = 5;
        encConfig->downmixInstructions[n].targetLayout = 5;
        encConfig->downmixInstructions[n].downmixCoefficientsPresent = 1;
        encConfig->downmixInstructions[n].downmixCoefficient[0*5+0] = 1.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[0*5+1] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[0*5+2] = 0.0f;
        ...
        encConfig->downmixInstructions[n].downmixCoefficient[3*5+3] = 1.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[3*5+4] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[4*5+0] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[4*5+1] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[4*5+2] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[4*5+3] = 0.0f;
        encConfig->downmixInstructions[n].downmixCoefficient[4*5+4] = 1.0f;
    }
    n=4;
    {
        encConfig->downmixInstructions[n].downmixId = 5;
        encConfig->downmixInstructions[n].targetChannelCount = 5;
        encConfig->downmixInstructions[n].targetLayout = 5;
        encConfig->downmixInstructions[n].downmixCoefficientsPresent = 1;
        encConfig->downmixInstructions[n].downmixCoefficient[0*5+0] = 1.0f;
