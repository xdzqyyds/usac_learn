...
int
configureEnc4_Amd1(EncParams* encParams,
              ...
              UniDrcGainExt* encGainExtension)
{
    ...
    eqCoefficients->uniqueFilterBlockCount = 2;
    b=0;
    {
        ...
        e=0;
        {
            ...
            eqCoefficients->filterBlock[b].filterElement[e].filterElementGain = -30.0f;
        }
    }
    b=1;
    {
    ...
    e=0;
    {
        ...
        eqCoefficients->uniqueTdFilterElement[e].realZeroRadiusOneCount   = 2;
        {
        ...
        eqCoefficients->uniqueTdFilterElement[e].genericZeroCount       = 1;
        {
            ...
            eqCoefficients->uniqueTdFilterElement[e].genericZeroAngle[0]  = 0.45f;
        }
        ...
        {
            eqCoefficients->uniqueTdFilterElement[e].complexPoleRadius[0] = 0.25f;
            eqCoefficients->uniqueTdFilterElement[e].complexPoleAngle[0]  = 0.55f;
        }
    ...
    e=2;
    {
        ...
        eqCoefficients->uniqueTdFilterElement[e].genericZeroCount       = 1;
        {
            eqCoefficients->uniqueTdFilterElement[e].genericZeroRadius[0] = 0.35f;
...
*/
    ...
    i=0;
    {
        ...
        eqInstructions->eqChannelCount = 2;
        ...
        g=0;
        {
            ...
            eqInstructions->tdFilterCascade.eqCascadeGain[g] = -22;
            eqInstructions->tdFilterCascade.filterBlockRefs[g].filterBlockCount = 2;
            {
                ...
                eqInstructions->tdFilterCascade.filterBlockRefs[g].filterBlockIndex[1] = 0;
            }
            eqInstructions->tdFilterCascade.eqPhaseAlignmentPresent = 1;
            eqInstructions->tdFilterCascade.eqPhaseAlignment[0][1] = 0;
            eqInstructions->tdFilterCascade.eqPhaseAlignment[1][0] = 0;
        }
    ...
    i=1;
    {
        EqInstructions* eqInstructions = &uniDrcConfigExt->eqInstructions[i];
        eqInstructions->eqSetId = i+1;
        /* eqInstructions->eqSetComplexityLevel = 2;  value will be computed */
        eqInstructions->downmixIdPresent = 0;
        eqInstructions->eqApplyToDownmix = 0;
