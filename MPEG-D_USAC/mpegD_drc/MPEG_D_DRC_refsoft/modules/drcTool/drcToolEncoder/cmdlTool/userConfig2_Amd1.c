...
int
configureEnc2_Amd1(EncParams* encParams,
                   ...
                   UniDrcGainExt* encGainExtension)
{
    ...
    encConfig->drcInstructionsUniDrcCount = 1;
    n=0;
    {
        ...
        g=1;
        {
            encConfig->drcInstructionsUniDrc[n].gainModifiers[g].gainScalingPresent[0] = 1;
            encConfig->drcInstructionsUniDrc[n].gainModifiers[g].attenuationScaling[0] = 2.0f;
            encConfig->drcInstructionsUniDrc[n].gainModifiers[g].amplificationScaling[0] = 2.0f;
            encConfig->drcInstructionsUniDrc[n].gainModifiers[g].gainOffsetPresent[0] = 1;
            encConfig->drcInstructionsUniDrc[n].gainModifiers[g].gainOffset[0] = -3.0f;
        }
    ...
    n=0;
    {
        encConfig->drcCoefficientsUniDrc[n].drcFrameSizePresent = 1;
        encConfig->drcCoefficientsUniDrc[n].drcFrameSize = encParams->frameSize;
    ...
    encConfig->uniDrcConfigExt.drcCoefficientsParametricDrc.parametricDrcDelayMax        = 960;
    ...
    s=1;
    {
        ...
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcLookAheadPresent = 1;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcLookAhead = 20;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcPresetIdPresent = 0;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcPresetId = 4;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcType = PARAM_DRC_TYPE_FF;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.levelEstimKWeightingType = 2;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.levelEstimIntegrationTimePresent = 0;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.levelEstimIntegrationTime = 64;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.drcCurveDefinitionType = 0;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.drcCharacteristic = 11;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeCount = 5;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeLevel[0] = -19;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeLevel[1] = 0;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeLevel[2] = 5;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeLevel[3] = 15;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeLevel[4] = 35;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeGain[0]  = 15;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeGain[1]  = 0;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeGain[2]  = 0;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeGain[3]  = -5;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.nodeGain[4]  = -24;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.drcGainSmoothParametersPresent = 1;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothAttackTimeSlow = 100;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothReleaseTimeSlow = 1000;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothTimeFastPresent = 1;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothAttackTimeFast = 10;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothReleaseTimeFast = 200;
        
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothThresholdPresent = 1;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothAttackThreshold = 10;
        encConfig->uniDrcConfigExt.parametricDrcInstructions[s].parametricDrcTypeFeedForward.gainSmoothReleaseThreshold = 10;
